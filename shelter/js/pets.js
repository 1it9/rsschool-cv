...
window.addEventListener('DOMContentLoaded', function() {
    ...
    $('.friends_list').slick({
        ...
        <button class="friends_arrow friends_prev" type="button">
            <img src="../image/Arrow1.svg" alt="arrow" class="friends_icon">
        </button>
        `,
        nextArrow:`
        <button class="friends_arrow friends_next" type="button">
            <img src="../image/Arrow.svg" alt="arrow" class="friends_icon"> 
        </button>
        `,
        responsive: [{
            breakpoint: 1279,
